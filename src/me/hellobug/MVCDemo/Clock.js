(function(){
    // 指针时钟
    Package("me.hellobug.display")
    .Class("AnalogClock")(function(AnalogClock, Super){
        AnalogClock.Constructor = function(canvasNodeId){
            this.update = createClock(canvasNodeId);
        }

        function createClock(canvasNodeId){
    ...
    // 数字时钟
    Package("me.hellobug.display")
    .Class("DigitalClock")(function(DigitalClock){
        DigitalClock.Constructor = function(canvasNodeId){
            this.update = createClock(canvasNodeId);
        }
